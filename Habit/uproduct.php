	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item cta cta-colored"><a href="cart_check.php" class="nav-link"><span class="icon-shopping_cart"></span><?php echo "[".$_SESSION['cart_count']."]" ?></a></li>
    ...
    <section class="ftco-section">
    	<div class="container">
    		<div class="row">
          	...
          	<p><a href="addcart.php?name= <?php echo $row['name']; ?>&price= <?php echo $row['price']; ?>&pic= <?php echo $row['pic']; ?>" class="btn btn-black py-3 px-5 mr-2">Add to Cart</a><a href="buynow.php?name= <?php echo $row['name']; ?>&price= <?php echo $row['price']; ?>&pic= <?php echo $row['pic']; ?>" class="btn btn-primary py-3 px-5">Buy now</a></p>
    			</div>
    		</div>

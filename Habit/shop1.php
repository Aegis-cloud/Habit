                    ...
                    <div class="sidebar">
                        <div class="sidebar-box-2">
                         <h2 class="heading">Categories</h2>
                            <div class="fancy-collapse-panel">
                                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                 ...
                                 <?php
                                    ...
                                    {
                                        ?>
                                                    <li><a href="shopcat1.php?cat=<?php echo $row1['sub_id']; ?>&id=<?php echo $cat; ?>"><?php echo $row1['sub_name']; ?></a></li>
                                        <?php
                                    }
                                        ?>
                                                </ul>
                            ...
                            <form method="post" class="colorlib-form-2" action="filterd1.php">
                                <div class="row">
                                    <div class="col-md-12">
                ...
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4 ml-md-5">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="about1.html" class="py-2 d-block">About</a></li>
                            <li><a href="account.php" class="py-2 d-block">My Account</a></li>
                            <li><a href="contact1.html" class="py-2 d-block">Contact</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-4">

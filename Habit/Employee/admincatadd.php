					...
					<div class="col-lg-12">
						<div class="banner-content">
						  <p class="text-white">&nbsp;</p>
                            <center> <p><font size="25">CATEGORY DETAILS</font></p></center>
<p>&nbsp;</p>
<center><div><form id="form1" name="form1" method="post" action="categoryadd.php">
  <table>
    <tbody>
        <tr>
        <td height="64">CATEGORY NAME</td>
        <td><label for="textfield2"></label>
          <input type="text" name="c_name" id="c_name" required></td>
      </tr>
                   <tr>
        <td>SUPPLIER NAME</td>
   ...
   $sql_department = "SELECT * FROM supplier";

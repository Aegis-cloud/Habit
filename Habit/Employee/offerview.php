...
include("connection.php");
   ...
   while($row = mysqli_fetch_assoc($department_data) ){
      $departname = $row['offerprice'];
      $departsid=$row['offerdiscount'];
	   $departprice=$row['offeritem'];
	   $departperiod=$row['id'];
	  
	  
?>
<form method="post" action="offerupdatenew.php">
    <table>
    <tbody>
  
      <tr>
        <td>Offer Id</td>
        <td><input type="text" name="sid" value="<?php echo $row['offerid']; ?>" ></td>
      </tr>
      <tr>
        <td>Offer price</td>
        ...
        <td><input type="text" name="text1" value="<?php echo $row['offerdiscount']; ?>"></td>
      </tr>
      <tr>
        <td>Item id</td>
          <td><input type="text" name="text3" value="<?php echo $row['id']; ?>"></td>
      </tr>
        </tbody>
    </table>

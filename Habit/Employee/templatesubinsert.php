					...
					<div class="col-lg-12">
						<div class="banner-content">
						  <p class="text-white">&nbsp;</p>
                            <center><p><font size="25"><strong>SUB</strong> <strong>CATEGORY INFORMATION</strong></font></p></center>
                         <center>   <div><form id="form1" name="form1" method="post" action="subcategoryinsert.php">
  <table>
    <tbody>
    <tr>

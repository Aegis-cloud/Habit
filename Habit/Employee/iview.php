...
include('connection.php');
   $sql_department = "SELECT * FROM item where id=$cid";
   $department_data = mysqli_query($conn,$sql_department);
   while($row = mysqli_fetch_assoc($department_data) ){

	  
?>
<form method="post" action="iupdatenew.php">
    <table>
    <tbody>
  
      <tr>
        <td></td>
        <td><input type="hidden" name="sid" value="<?php echo $row['id']; ?>" ></td>
      </tr>
      <tr>
        <td>Item name</td>
      ...
      <tr>
        ...
        <td>Category ID</td>
        <td>
          <input type="text" name="cat" value="<?php echo $row['cat_id']; ?>">
          </td>  
        </tr>
        <tr>
        <td>Quantity</td>
        <td>
          <input type="text" name="quan" value="<?php echo $row['quan']; ?>">
          </td>  
        </tr>
        <tr>
        <td>Fabric</td>
        <td>
         <input type="text" name="fabric" value="<?php echo $row['fabric']; ?>">
          </td>  
        </tr>
        <tr>
        <td>Color</td>
        ...
        <td>Pattern</td>
        <td>
        <input type="text" name="pattern" value="<?php echo $row['pattern']; ?>">
          </td>  
        </tr>
             </tbody>
    </table>

...
?>
<form method="post" action="billdeletefinal.php"><label>Bill id</label>
<input type="text" value="<?php echo $row['billid']; ?>" name="cid">
<label>Order id</label>
<input type="text" name="cname" value="<?php echo $row['orderid']; ?>">
	<label>No. of items</label>
<input type="text" name="cname1" value="<?php echo $row['no_of_items']; ?>">
<label>Total Amount</label>
<input type="text" name="cname2" value="<?php echo $row['totalamount']; ?>">

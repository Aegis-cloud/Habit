...
?>
<form method="post" action="ideletefinal.php">
    <table>
    <tbody>
            <tr>
        <td>Item Id</td>
          <td><input type="text" value="<?php echo $row['id']; ?>" name="cid" readonly></td>
      </tr>
         <tr>
        <td>Item name</td>
        ...
        <tr>
        <td>Price</td>
          <td><input type="text" name="cname2" value="<?php echo $row['price']; ?>"></td>
      </tr>
        <tr>
        <td>Quantity</td>
          <td><input type="text" name="cname4" value="<?php echo $row['quan']; ?>"></td>
      </tr>
        </tbody>
    </table>

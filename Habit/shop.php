        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active"><a href="index.php" class="nav-link" style="color:black;"><strong>Home</strong></a></li>
                    <li class="nav-item cta cta-colored"><a href="shop.php" class="nav-link" style="color:black;"><strong>shop</strong></a></li>
                    <li class="nav-item"><a href="about.html" class="nav-link" style="color:black;"><strong>About</strong></a></li>
                    <li class="nav-item"><a href="log/index.html" class="nav-link" style="color:black;"><strong>LOGIN</strong></a></li>
                    <li class="nav-item"><a href="contact.html" class="nav-link" style="color:black; "><strong>Contact</strong></a></li>
                ...
                <div class="col-md-4 col-lg-2">
                    <div class="sidebar">
                            ...
                            <div class="fancy-collapse-panel">
                                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="headingOne">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion" href="#<?php echo $row['cat_name']; ?>" aria-expanded="true" aria-controls="collapseOne" style="color:Maroon"><?php echo $row['cat_name']; ?>
                                                </a>
                                            </h4>
                                        </div>
                                 ...
                                 <?php
                                    ...
                                    {
                                        ?>
                                                    <li><a href="shopcat.php?cat=<?php echo $row1['sub_id']; ?>&id=<?php echo $cat; ?>"><?php echo $row1['sub_name']; ?></a></li>
                                        <?php
                                    }
                                        ?>
                                                </ul>
                        ...
                        <div class="sidebar-box-2">
                            ...
                            <form method="post" class="colorlib-form-2" action="filterd.php">
                                <div class="row">
                                    <div class="col-md-12">

...
?>
<form method="post" action="supupdatefinal.php">
<table>
    <tbody>
      <tr>
      ...
      <tr>
        ...
        <td><label for="textfield2"></label>
          <input type="text" name="sname" value="<?php echo $row['SUPPLIER_NAME']; ?>"></td>
      </tr>
      <tr>
        <td height="50"><p>HOUSE  NUMBER</p></td>
        <td><label for="textfield3"></label>
         <input type="text" name="hno" value="<?php echo $row['HOUSE_NUMBER']; ?>"></td>
      </tr>
      <tr>
        <td height="48">STREET  NAME</td>
        <td><label for="textfield4"></label>
          <input type="text" name="stname" value="<?php echo $row['STREET_NAME']; ?>"></td>
      </tr>
      <tr>
        <td height="48">STREET  TYPE</td>
        <td><label for="textfield5"></label>
          <input type="text" name="stype"  value="<?php echo $row['STREET_TYPE']; ?>"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><label for="textfield7"></label>
          <input type="text" name="con" value="<?php echo $row['CONTACT']; ?>"></td>
      </tr>
      <tr>
        <td height="59">EMAIL</td>
        <td><label for="email"></label>
          <input type="text" name="mail" value="<?php echo $row['EMAIL']; ?>"></td>
      </tr>
    </tbody>
  </table>

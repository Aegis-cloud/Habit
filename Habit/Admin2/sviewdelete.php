...
?>
<form method="post" action="sdeletefinal.php"><label>SUB_ID</label>
<input type="text" value="<?php echo $row['sub_id']; ?>" name="cid">
<label>SUB_NAME</label>
<input type="text" name="cname" value="<?php echo $row['sub_name']; ?>">
	<label>CAT_NAME</label>
<input type="text" name="cname1" value="<?php echo $row['cat_id']; ?>">

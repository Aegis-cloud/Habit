    ...
    <tbody>
      ...
      <tr>
        ...
        <td><label for="textfield3"></label>
          <input type="text" name="sname" value="<?php echo $row['SECOND_NAME']; ?>"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><label for="textfield5"></label>
          <input type="text" name="hname" value="<?php echo $row['HOUSE_NAME']; ?>"></td>
      </tr>
      <tr>
        <td height="53">POST OFFICE</td>
        <td><label for="textfield6"></label>
          <input type="text" name="poff" value="<?php echo $row['POST_OFFICE']; ?>"></td>
      </tr>
      <tr>
        <td height="60">CITY</td>
        <td><label for="textfield8"></label>
          <input type="text" name="city" value="<?php echo $row['CITY']; ?>"></td>
      </tr>
      <tr>
        <td height="59">JOIN DATE</td>
        <td><label for="textfield9"></label>
          <input type="text" name="jdate" value="<?php echo $row['JOIN_DATE']; ?>"></td>
      </tr>
		<tr>
        <td height="59">DESIGNATION</td>
        <td><label for="textfield10"></label>
         <input type="text" name="des" value="<?php echo $row['DESIGNATION']; ?>"></td>
      </tr>
		<tr>
        <td height="59">CONTACT NO</td>
        <td><label for="textfield11"></label>
          <input type="text" name="cno" value="<?php echo $row['CONTACT_NO']; ?>"></td>
      </tr>
		<tr>
        <td height="59">EMAIL</td>
        <td><label for="email"></label>
          <input type="text" name="email" value="<?php echo $row['EMAIL']; ?>"></td>
      </tr>
    </tbody>
  </table>

	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item cta cta-colored active"><a href="user.php" class="nav-link"><strong>Home</strong></a></li>
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
		          		...
		          		<div class="horizontal">
				            ...
				            <p><a href="shop1.php" class="btn-custom">Discover Now</a></p>
				          </div>
		            </div>
		          </div>
	        	</div>
				...
				<div class="row no-gutters">
					<div class="col-lg-4">
    					...
    					<div class="text text-center text-white px-2">
    						...
    						<p>................................</p>
    						<p><a href="shop1.php" class="btn btn-black px-3 py-2">Shop now</a></p>
    					</div>
    				</div>
					</div>
					<div class="col-lg-8">
                ...
                while($row=mysqli_fetch_assoc($sql))
                {
                    ?>
							...
							<ul class="thumb-deal d-flex mt-4">
                                ...
                                <a href="singleproduct1.php?id= <?php echo $row['id']; ?>" ><li class="img"  style="background-image: url('<?php echo $row['offeritem']; ?>');"></li></a>

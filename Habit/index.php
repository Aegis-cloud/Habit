...
<html lang="en">
  ...
  <body class="goto-here">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item cta cta-colored active"><a href="index.php" class="nav-link"><strong>Home</strong></a></li>
	          <li class="nav-item"><a href="shop.php" class="nav-link"><strong>shop</strong></a></li>
	      ...
	      <div class="slider-item js-fullheight">
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-md-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
	          	<img class="one-third order-md-last img-fluid" src="images/bg.jpg" alt="">
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
		          		<span class="subheading">#New Arrival</span>
		          		<div class="horizontal">
							<h1 class="mb-4 mt-3">Men's Collection 2019</h1>
                             <p class="mb-4">........................................................................</p>
	      ...
	      <div class="slider-item js-fullheight">
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
	          	<img class="one-third order-md-last img-fluid" src="images/tf4.jpg" alt="">
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
		          		<span class="subheading">#New Arrival</span>
		          		<div class="horizontal">
				            <h1 class="mb-4">Latest apparels</h1>
				            <p class="mb-4">...............................................</p>
    ...
    <section class="ftco-section bg-light">
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
            <h2 class="mb-4">New Collections</h2>
            <p>.........................................</p>
          </div>
        </div>   		
    	</div>
    	...
    	<div class="container">
				<div class="row no-gutters">
    				...
    				<div class="row no-gutters choose-wrap divider-two align-items-stretch">
    					<div class="col-md-12">
	    					<div class="choose-wrap full-wrap img align-self-stretch d-flex align-item-center justify-content-end" style="background-image: url(images/P9.jpg);">
    							...
    							<div class="col-md-6">
		    						<div class="choose-wrap wrap img align-self-stretch bg-light d-flex align-items-center">
		    							<div class="text text-center px-5">
				    						...
				    						<h2>Extra 50% Off</h2>
				    						<p>Enjoy this summer with our latest cool collections...</p>
				    						<p><a href="shop.php" class="btn btn-black px-3 py-2">Shop now</a></p>
				    					</div>
		    						</div>
	    						</div>
	    						<div class="col-md-6">
		    						<div class="choose-wrap wrap img align-self-stretch d-flex align-items-center" style="background-image: url(images/bg.jpg);">
    ...
    <section class="ftco-section ftco-deal ftco-bg-dark">
    	<div class="container">
    		<div class="row">
    		<?php
                $a="SELECT * FROM offers LIMIT 1";
	            $sql=mysqli_query($conn,$a);
                while($row=mysqli_fetch_assoc($sql))
                {
                    ?>
    			...
    			<div class="col-md-6">
                    <a href="singleproduct1.php?id= <?php echo $row['id']; ?>" class="img-prod"><img class="img-fluid" src="<?php echo $row['offeritem']; ?>" alt="Colorlib Template"></a>
    			</div>
                    <?php
                }
                ?>
    			<div class="col-md-6">
    				<div class="heading-section heading-section-white">
    					<span class="subheading">Deals of the month</span>
	            <h2 class="mb-3"> OFFER ZONE</h2>
	          </div>
    				<div id="timer" class="d-flex mb-4">
						...
						<div class="text-deal">
							<h2><a href="#">50% deals</a></h2>
							<p>&nbsp;<a href="shop1.php" class="btn btn-black px-3 py-2">Shop all now</a></p>
							<p class="price"><span class="mr-2 price-dc">10%</span><span class="price-sale">50%</span></p>
										<?php
                $a="SELECT * FROM offers where offerid>1 LIMIT 3";
	            $sql=mysqli_query($conn,$a);
                while($row=mysqli_fetch_assoc($sql))
                {
                    ?>
							...
							<ul class="thumb-deal d-flex mt-4">
                                ...
                                <a href="singleproduct.php?id= <?php echo $row['id']; ?>" ><li class="img"  style="background-image: url('<?php echo $row['offeritem']; ?>');"></li></a>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2"><strong>habit</strong>
              </h2>

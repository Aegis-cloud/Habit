...
<body class="goto-here">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="cart.html" class="nav-link"><strong><span class="icon-shopping_cart"></span>[0]</strong></a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('images/sh1.jpg');">
        <div class="container">
              ...
              ?>
                        <div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
                            <div class="product d-flex flex-column">
                                <a href="#" class="img-prod"><img class="img-fluid" src="<?php echo $row['pic']; ?>" alt="Colorlib Template">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="headingOne">
                                            <h4 class="panel-title">
                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse" aria-expanded="true" aria-controls="collapse"><?php echo $row1['cat_name']; ?>
                                                </a>
                                        ...
                                        <div id="collapse" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                                            <div class="panel-body">
                                                <ul>
                                                    <?php
                                                   $c="SELECT * FROM subcategory where category='shirt'";
                                                    $sql2=mysqli_query($conn,$c);
                                                    while($row2=mysqli_fetch_assoc($sql2))
                                                          {
                                                              ?>

                                                    <li><a href="shopcat.php?cat='formal'"><?php echo $row2['sub_name'];?></a></li>

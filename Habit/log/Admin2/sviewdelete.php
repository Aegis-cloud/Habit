...
?>
<form method="post" action="sdeletefinal.php"><label>Sid</label>
<input type="text" value="<?php echo $row['sid']; ?>" name="cid">
<label>Sname</label>
<input type="text" name="cname" value="<?php echo $row['sname']; ?>">
	<label>Cid</label>
<input type="text" name="cname1" value="<?php echo $row['cid']; ?>">
